# 03 — Product Strategy and Requirements V3.1-ZH
| Field | Value |
|---|---|
| Logical ID | `TC.V3_1_ZH.PRODUCT_REQUIREMENTS` |
| Generation | `traincapsule-v3.1-zh-2026-08-12` |
| Authority class | `normative_product` |
| Derived from | `TC.V3.PRODUCT_REQUIREMENTS` |
...
- technical decision owner with meaningful training spend.
...
- expiry;
- required follow-up;
- verifier-policy and machine-receipt metadata.
...
- unverified intuition is the only oracle;
...
8. commercial support is based on current machine-policy-authorized trust and security evidence.
