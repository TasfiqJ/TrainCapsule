...
class WorkKind(StrEnum):
    ...
    MACHINE_POLICY_REVIEW = "MACHINE_POLICY_REVIEW"
...
class EvidenceType(StrEnum):
    ...
    SECOND_ACTION_COMMITMENT = "SECOND_ACTION_COMMITMENT"
    GPU_EXECUTION = "GPU_EXECUTION"
    SAME_FAMILY_CASE = "SAME_FAMILY_CASE"
...
class ReleaseDecision(StrEnum):
    NOT_EVALUATED = "NOT_EVALUATED"
    HOLD = "HOLD"
    APPROVED_FOR_DIRECT_MAIN = "APPROVED_FOR_DIRECT_MAIN"
    APPROVED_FOR_AUTOMATED_PULL_REQUEST = "APPROVED_FOR_AUTOMATED_PULL_REQUEST"
    PULL_REQUEST_PENDING_REQUIRED_CHECKS = "PULL_REQUEST_PENDING_REQUIRED_CHECKS"
    MERGED_MAIN_VERIFIED = "MERGED_MAIN_VERIFIED"
    REJECTED = "REJECTED"
