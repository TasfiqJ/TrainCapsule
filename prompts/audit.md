...
Return at most 8 findings total using the global concrete finding format. Do not edit product files, weaken gates, mutate the roadmap, promote a release, or hide missing evidence. Required external truth becomes WAITING_EXTERNAL; missing deterministic authority becomes BLOCKED_POLICY.
