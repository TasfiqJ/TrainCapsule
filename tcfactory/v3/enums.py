...
class ReleaseDecision(StrEnum):
    NOT_EVALUATED = "NOT_EVALUATED"
    HOLD = "HOLD"
    APPROVED_FOR_MAIN_PROMOTION = "APPROVED_FOR_MAIN_PROMOTION"
    MAIN_PROMOTED_PENDING_HOSTED_CHECKS = "MAIN_PROMOTED_PENDING_HOSTED_CHECKS"
    MAIN_VERIFIED = "MAIN_VERIFIED"
    REVERTED_AND_QUARANTINED = "REVERTED_AND_QUARANTINED"
    REJECTED = "REJECTED"
