...
The launcher must honor STOP, PAUSE, locks, finite supervisor restart budgets, migration state, and credential-provider boundaries. It must not start paid model work during tests, create hidden network activity, loop without bound, or bypass exact-SHA gates, the independent machine receipt, ordinary non-force direct-main publication, and verified-main policy.
