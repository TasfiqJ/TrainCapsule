...
Select one mutating owner for the candidate and only bounded read-only reviewers. Give every role finite turns, token/cost estimates, retries, and elapsed time. Use UNKNOWN for unavailable technical truth, WAITING_EXTERNAL for trusted external receipts, and BLOCKED_POLICY for missing machine authority. Never fabricate evidence or authority.
