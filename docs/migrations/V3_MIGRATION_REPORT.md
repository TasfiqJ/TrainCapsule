...
Compared with `6b480232fa92b069103da44c475bd17bcb3e6bd1`: **689 paths**.
...
| `A` | `config/source_precedence.yaml` |
...
| `A` | `docs/migrations/V3_MIG_002_ROLLBACK_ATTESTATION.json` |
...
| `A` | `docs/migrations/evidence/V3-MIG-003.json` |
| `A` | `docs/migrations/evidence/V3-MIG-004.json` |
| `A` | `docs/migrations/evidence/V3-MIG-005.json` |
| `A` | `docs/migrations/evidence/V3-MIG-006-scheduler-simulation.json` |
| `A` | `docs/migrations/evidence/V3-MIG-007.json` |
| `A` | `docs/migrations/evidence/V3-MIG-009.json` |
| `A` | `docs/migrations/evidence/V3-MIG-009.schema.json` |
| `A` | `docs/migrations/evidence/V3-MIG-010.json` |
| `A` | `docs/migrations/evidence/V3-MIG-011.json` |
...
| `A` | `docs/migrations/evidence/transcripts/V3-MIG-002-rollback-rehearsal.json` |
...
| `A` | `docs/migrations/evidence/v3.1-zh/V3-MIG-001-reverification.json` |
| `A` | `docs/migrations/evidence/v3.1-zh/V3-MIG-008-reverification.json` |
...
| `A` | `schemas/factory/v3/maturity-state.schema.json` |
| `A` | `schemas/factory/v3/maturity-target.schema.json` |
| `A` | `schemas/factory/v3/migration-complete-marker.schema.json` |
| `A` | `schemas/factory/v3/migration-evidence.schema.json` |
| `A` | `schemas/factory/v3/migration-installation-evidence.schema.json` |
...
| `A` | `schemas/migrations/v3-mig-001-reverification.schema.json` |
| `A` | `schemas/migrations/v3-mig-008-reverification.schema.json` |
...
| `A` | `scripts/gates/v3_mig_001_reverification.py` |
| `A` | `scripts/gates/v3_mig_002_rollback_rehearsal.py` |
| `A` | `scripts/gates/v3_mig_004_evidence.py` |
...
| `A` | `scripts/generate_v3_mig_003_evidence.py` |
...
| `A` | `tcfactory/backends/registry.py` |
...
| `A` | `tcfactory/v3/mig_001_reverification.py` |
| `A` | `tcfactory/v3/mig_008_reverification.py` |
| `A` | `tcfactory/v3/migration_evidence.py` |
| `A` | `tcfactory/v3/migration_installation_evidence.py` |
...
| `A` | `tcfactory/v3/rollback_rehearsal.py` |
...
| `A` | `tests/test_v3_completion_audit_proposal_only.py` |
...
| `A` | `tests/test_v3_executor_registry.py` |
| `A` | `tests/test_v3_github_workflows.py` |
| `A` | `tests/test_v3_legacy_migration.py` |
| `A` | `tests/test_v3_machine_policy.py` |
| `A` | `tests/test_v3_mig_001_reverification.py` |
| `A` | `tests/test_v3_mig_002_rollback_rehearsal.py` |
| `A` | `tests/test_v3_mig_003_installation_evidence.py` |
| `A` | `tests/test_v3_mig_004_source_precedence.py` |
| `A` | `tests/test_v3_mig_005_models.py` |
| `A` | `tests/test_v3_mig_006_scheduler_evidence.py` |
| `A` | `tests/test_v3_mig_008_reverification.py` |
| `A` | `tests/test_v3_mig_009_external_evidence.py` |
