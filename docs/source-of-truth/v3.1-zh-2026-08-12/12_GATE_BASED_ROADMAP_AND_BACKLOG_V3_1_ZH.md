# 12 — Gate-Based Roadmap and Backlog V3.1-ZH
| Field | Value |
|---|---|
| Logical ID | `TC.V3_1_ZH.ROADMAP` |
| Generation | `traincapsule-v3.1-zh-2026-08-12` |
| Authority class | `normative_roadmap` |
| Derived from | `TC.V3.ROADMAP` |
...
TRUST        — create independent oracles, security evidence, and independent machine authority
```
...
- V3.1-ZH source authority installed and integrity-checked;
...
- rollback tested;
- independent machine-policy authorization of source migration recorded.
...
| `V3-MIG-003` | TRUST | Install V3.1-ZH documents without mutating old bundle | 001 | source tree, authority diff |
...
| `V3-MIG-008` | TRUST | Add signed independent machine-policy receipt model and trusted-root verification | 005 | positive/negative/expiry/SHA tests |
...
| `V3-MIG-016` | TRUST | Machine-policy evaluation of authority, release, and rollback | 003–015 | signed source-migration machine authorization |
| `V3-MIG-017` | FACTORY | Run controlled migration rehearsal and rollback | 006–015 | full transcript and restored SHA |
| `V3-MIG-018` | FACTORY | Enable V3.1-ZH controller in observation mode | 016,017 | scheduler decisions with no mutation |
...
- machine-authority root can be written by AI roles;
- release can still bypass PR/machine-policy policy;
- rollback cannot restore baseline;
- V3.1-ZH scheduler still serializes all lanes behind one item.
...
- data/AI boundary;
- initial independent-verifier/private-oracle plan.
...
- qualified independent machine policy authorizes only controlled external demonstration, not commercial support.
...
| `V3-TRUST-010` | TRUST | Machine-policy evaluation of controlled demonstration | all M2 trust/product | scoped signed receipt |
...
- private-oracle and verifier availability confirmed;
...
| `V3-TRUST-013` | TRUST | Contract security private-oracle policy | M2 | external receipt |
...
| `V3-MKT-010` | MARKET | Secure attributable customer authorization for paid preflight proposal | MKT-006,008–009,TRUST-011 | signed/external receipt |
| `V3-DEC-003` | TRUST | Authorize paid preflight | PROD-028,COMP-006,TRUST-012–013,MKT-010 | independent machine-policy decision |
...
- attributable customer privacy authorization and machine-policy security authorization;
...
| `V3-PILOT-005` | TRUST | Independent machine-policy authorize case-specific experiment/reduction plan | 004 | signed machine-policy receipt |
...
| `V3-PILOT-010` | TRUST | Independent machine-policy authorize customer-facing claims | 009 | signed machine-policy receipt |
...
- no trust-core rewrite;
- independent machine-policy pack authorization;
...
| `V3-TRUST-015` | TRUST | Independent machine authority commercial-pack machine authorization | 014 | signed machine-policy receipt |
...
- external/policy wait visibility;
- no autonomous external contact.

### Weekly autonomous evidence review
...
- next policy-controlled or external action.
