...
8. Provide deterministic commands that verify behavior. Do not rely on an LLM saying that code looks correct.
...
10. Use Sonnet for ordinary implementation and Opus only for truth-critical specification, research, or adversarial work.
