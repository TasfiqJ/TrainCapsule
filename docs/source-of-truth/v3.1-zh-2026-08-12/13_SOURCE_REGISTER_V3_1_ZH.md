# 13 — Current Source and Competitive Register V3.1-ZH
| Field | Value |
|---|---|
| Logical ID | `TC.V3_1_ZH.SOURCE_REGISTER` |
| Generation | `traincapsule-v3.1-zh-2026-08-12` |
| Authority class | `current_fact_register` |
| Derived from | `TC.V3.SOURCE_REGISTER` |
...
- Factory consequence:
  ...
  - durable roadmap, release, evidence, and machine-policy receipt state remain tool-neutral.
